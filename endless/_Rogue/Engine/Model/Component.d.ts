...
type ComponentInterfaceType = 'String' | 'Number' | 'Boolean' | 'Select' | 'Vector2' | 'Vector3' | 'Object3D' | 'Prefab' | 'Texture' | 'Material' | 'Component' | 'Audio' | 'Color' | 'ColorString' | 'PositionalAudio' | 'AnimationClip' | 'Button' | 'Data' | 'Code';
